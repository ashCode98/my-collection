...
Python
    ...
    Invisibility Cloak
        ...
        Similar to Harry Potter to make you invisible when you put a red cloth in front of you, with Python OpenCV Library.
...
2. [:film_strip: \[rus\] Design patterns (brief)](https://www.youtube.com/playlist?list=PLmqFxxywkatSzlcVEJTsMqZ1ObLO6vqCe)
3. [:film_strip: \[rus\] Design patterns (full)](https://www.youtube.com/playlist?list=PLmqFxxywkatStbd9hdzVOS1hZa9dc56k4)
4. [:scroll: \[eng\] Java Design Patterns - online catalog](https://java-design-patterns.com/patterns/observer/)
5. [:scroll: \[eng\] The Builder pattern vs Java syntax](https://bsideup.github.io/posts/builders_vs_java/)
6. [:scroll: \[eng\] Awesome Software and Architectural Design Patterns](https://github.com/DovAmir/awesome-design-patterns#awesome-software-and-architectural-design-patterns)
...
### TTD in JavaScript
1. [:film_strip: \[eng\] React Unit Testing](https://www.youtube.com/watch?v=3e1GHCA3GP0)

# IDEs

## Linux

1. [:film_strip: \[rus\] Unix philosophy by unixway](https://www.youtube.com/watch?v=ExmBIpgM0kI)
...
<details open>
  ...
  <ol>
    <li><a href="https://amzn.to/2N0dzNb" target="blank">Clean Architecture</a></li>
    <li>
      <a href="https://amzn.to/2JIjOrz" target="blank">Clean Code: A Handbook of Agile Software Craftsmanship</a> 
    </li>
    <li><a href="https://amzn.to/2L6mcE0" target="blank">Code Complete</a> </li>
    <li><a href="https://amzn.to/2MlI3wW" target="blank">Cracking the Coding Interview</a></li>
    <li><a href="https://amzn.to/2NPhvRX" target="blank">The Clean Coder</a></li>
    <li><a href='http://amzn.to/2BNciX2' target="blank">The Complete Software Developer's Career Guide</a></li>
    <li><a href="https://amzn.to/39O7hMm" target="blank">The Pragmatic Programmer</a></li>
    <li>
      <a href="https://amzn.to/37JCaQj" target="blank">The Mythical Man-Month: Essays on Software Engineering</a>
    </li>
    <li>
      <a href="https://amzn.to/2s7BKEk" target="blank">Soft Skills: The software developer's life manual</a>
    </li>
    <li>
      <a href="https://amzn.to/35DDaUU" target="blank">HTML and CSS: Design and Build Websites</a>
    </li>
    <li>
      <a href="https://amzn.to/2FvYl0e" target="blank">Head First Design Patterns: A Brain-Friendly Guide</a> 
    </li>
    <li>
      <a href="https://amzn.to/2T4zrNk" target="blank">Grokking Algorithms: An illustrated guide for programmers and
        other curious people</a>
    </li>
    <li><a href="https://amzn.to/37KZsFq" target="blank">A Smarter Way to Learn JavaScript. The new tech-assisted
        approach that requires half the effort</a></li>
    <li>
    ...
    <li>
      <a href="https://amzn.to/2TWfwPg" target="blank">Structure and Interpretation of Computer Programs</a>
    </li>
    <li>
      <a href="https://www.buymeacoffee.com/GoalKickerBooks" target="blank">Goal Kicker</a> 
    </li>
    <li>
      <a href="https://launchschool.com/books" target="blank">LaunchSchool Books</a>
    </li>
  </ol>
</details>
...
* [Stripe Documentation](https://stripe.com/docs) and [Full API Documentation](https://stripe.com/docs/api) 
...
* [Digital Ocean API Docs](https://docs.digitalocean.com/reference/api/)
...
* [dexy](https://www.dexy.it) - Extensible documentation/report generator supporting multiple programming languages and several input and output formats. (contributed by [troytop](http://github.com/troytop))
...
* [Pickles](https://www.picklesdoc.com/) - Pickles is an open source living documentation generator that works on feature files written in the Gherkin language.
...
<ul>
    ...
    <li><a href="https://github.com/jamiebuilds/itsy-bitsy-data-structures">Itsy Bitsy Data Structures</a> - In here are super simplified examples of many of the common data structures written in easy to read JavaScript.</li>
    <li><a href="https://github.com/iamtodor/data-science-interview-questions-and-answers">Data Science Interview Questions And Answers</a> - Data science interview questions with answers.</li>
    <li><a href="https://github.com/Just-A-Visitor/Algorithmic-Pseudocode">Algorithmic Pseudocode</a> - This repository contains the pseudocode(pdf) of various algorithms and data structures necessary for Interview Preparation and Competitive Coding</li>
    <li><a href="https://github.com/FAQGURU/FAQGURU">Faq Guru</a> - A list of interview questions. This repository is everything you need to prepare for your technical interview.</li>
    <li><a href="https://github.com/jonathan-bower/DataScienceResources">Data Science Resources</a> -Open Source Data Science Resources. </li>
    <li><a href="https://github.com/learning-zone/website-templates#html5-website-templates-for-begginers-and-professionals">HTML5 Website Templates</a> - A repositoroty that contains 150+ Website Templates.</li>
    <li><a href="https://github.com/sudheerj/vuejs-interview-questions">Vuejs Interview Questions</a> - List of 300 VueJS Interview Questions And Answers</li>
    <li><a href="https://github.com/sachuverma/DataStructures-Algorithms">Data Structures & Algorithms</a> - This repo contains links of resources, theory subjects content and DSA questions & their solution for interview preparation from different websites like geeksforgeeks, leetcode, etc.</li>
    <li><a href="https://github.com/devAmoghS/Machine-Learning-with-Python">Machine Learning With Python</a> - Small scale machine learning projects to understand the core concepts</li>
    <li><a href="https://github.com/rbhatia46/Data-Science-Interview-Resources">Data Science Interview Resources </a> A repository listing out the potential sources which will help you in preparing for a Data Science/Machine Learning interview.</li>
    <li><a href="https://github.com/MrMimic/data-scientist-roadmap">Data Scientist Roadmap</a> - A roadmap to start your data science career.</li>
    <li><a href="https://github.com/mtdvio/every-programmer-should-know">Every Programmer Should Know </a> - A collection of (mostly) technical things every software developer should know about.</li>
    <li><a href="https://github.com/alexeygrigorev/data-science-interviews">Data Science Interviews</a> - Data science interview questions and answers. </li>
    <li><a href="https://github.com/binhnguyennus/awesome-scalability">Awesome Scalability</a> - The Patterns of Scalable, Reliable, and Performant Large-Scale Systems.</li>
    <li><a href="https://github.com/twowaits/SDE-Interview-Questions">SDE Interview Questions</a> - Most comprehensive list clipboard of tech interview questions blue_book of companies scraped from Geeksforgeeks, CareerCup and Glassdoor.</li>
    <li><a href="https://github.com/checkcheckzz/system-design-interview">System Design Interview</a> - System design interview for IT companies</li>
    <li><a href="https://github.com/donnemartin/interactive-coding-challenges">Interactive Coding Challenges</a> - 120+ interactive Python coding interview challenges (algorithms and data structures). Includes Anki flashcards.</li>
    <li><a href="https://github.com/GalvanizeOpenSource/100-ds-problems">100 Data Science Programming Problems</a> - Here are 100 data science programming problems. </li>
    <li><a href="https://github.com/elsewhencode/project-guidelines">Project Guidelines</a> - A set of best practices for JavaScript projects</li>
    <li><a href="https://github.com/AsishRaju/450-DSA">450-DSA Cracker </a> - 450-DSA helps you track your progress in solving 400+ DSA questions and keeps you engaging based on DSA-Cracker Sheet </li>
    <li><a href="https://github.com/khangich/machine-learning-interview">Machine Learning Interviews</a> - Machine Learning Interviews from FAAG, Snapchat, LinkedIn. I have offers from Snapchat, Coupang, Stitchfix etc.</li>
    <li><a href="https://github.com/Olshansk/interview">Interview</a> - Everything you need to prepare for your technical interview</li>
    <li><a href="https://github.com/goldbergyoni/javascript-testing-best-practices">JavaScript & Node.js Best Testing Practices</a> Comprehensive and exhaustive JavaScript & Node.js testing best practices</li>
    <li><a href="https://github.com/sudheerj/angular-interview-questions">Angular Interview Questions & Answers</a> - List of 300 Angular Interview Questions and answers</li>
    <li><a href="https://github.com/GalvanizeOpenSource/100-ds-problems">100 Data Science Programming Problems</a> - Here are 100 data science programming problems.</li>
    <li><a href="https://github.com/prasadgujar/low-level-design-primer">Interlow level design primerview</a> - Dedicated Resources for the Low-Level System Design. Learn how to design and implement large-scale systems. Prep for the system design interview.</li>
    <li><a href="https://github.com/amilajack/reading">Computer Science Reading List</a> - A list of computer-science readings I recommend</li>
    <li><a href="https://github.com/Olshansk/interview">Interview</a> - Everything you need to prepare for your technical interview</li>
    <li><a href="https://github.com/aershov24/web-developer-interview-questions">Web Developer Interview Questions</a> - Web Developer Interview questions and answers.</li>
    <li><a href="https://github.com/goldbergyoni/various-testing-examples">Javascript Testing A-Z</a> - JavaScript & Node.js testing workshop, from A-Z</li>
    <li><a href="https://github.com/NoriSte/ui-testing-best-practices">UI Testing Best Practices</a> - The largest UI testing best practices list.</li>
    <li><a href="https://github.com/goldbergyoni/nodebestpractices">Node.js Best Practices</a> - The Node.js best practices list.</li>
    <li><a href="https://github.com/puncsky/system-design-and-architecture">System Design and Architecture</a> - Learn how to design large-scale systems. Prep for the system design interview.</li>
    <li><a href="https://github.com/jdsutton/Technical-Interview-Megarepo">Technical Interview Mega Repo</a> - Study materials for SE/CS technical interviews.</li>
    <li><a href="https://github.com/indy256/Full-stack-Developer-Interview-Questions-and-Answers">Full-stack Developer Interview Questions and Answers</a> - Full-stack developer interview questions and answers.</li>
    <li><a href="https://github.com/kdn251/interviews">Interviews</a> - Everything you need to know to get the job.</li>
    <li><a href="https://github.com/louisfb01/start-machine-learning-in-2020">Start Machine Learning</a> - A complete guide to start and improve in machine learning (ML), artificial intelligence (AI) without ANY background in the field and stay up-to-date with the latest news and state-of-the-art techniques!</li>
    <li><a href="https://github.com/arialdomartini/Back-End-Developer-Interview-Questions">Back-End Developer Interview Questions</a> - A list of back-end related questions you can be inspired from to interview potential candidates, test yourself or completely ignore.</li>
    <li><a href="https://github.com/apptension/developer-handbook">Developer Handbook</a> - An opinionated guide on how to become a professional Web/Mobile App Developer.</li>
    <li><a href="https://github.com/30-seconds/30-seconds-of-interviews">30 seconds of interviews</a> - A curated collection of common interview questions to help you prepare for your next interview.</li>
     <li><a href="https://github.com/TheAlgorithms/Algorithms-Explanation">Algorithms Explanation</a> - Popular algorithms explained in simple language with examples and links to their implementation in various programming languages and other required resources.</li>
    <li><a href="https://github.com/DopplerHQ/awesome-interview-questions">Awesome Interviews </a> - A curated awesome list of lists of interview questions. Feel free to contribute!</li>
...
- [Linux documentry](https://www.youtube.com/watch?v=XMm0HsmOTFI) : Story of Linux documentary
...
* Media
  ...
  * [What you Must Know about html video, audio](http://net.tutsplus.com/tutorials/html-css-techniques/html5-audio-and-video-what-you-must-know/)
...
* Intro
  ...
  * [RisingStack's](https://blog.risingstack.com/node-js-at-scale-understanding-node-js-event-loop/)
...
- Siraj Raval (https://m.youtube.com/c/SirajRaval)
- GFXMentor (https://www.youtube.com/GFXMentor)
- Gaurav Sen (https://www.youtube.com/channel/UCRPMAqdtSgd0Ipeef7iFsKw)
...
- Deep Learning Playlist (https://m.youtube.com/playlist?list=PLZoTAELRMXVPGU70ZGsckrMdr0FteeRUi)
- Rachel Thomas Playlist (https://www.youtube.com/channel/UCDGdZy8VUUXjM6SuJOpznDg) 
- Cornell Tech - Applied ML Playlist (https://www.youtube.com/watch?v=vcE9WGbi4QY)
- CodeWithHarry (https://www.youtube.com/channel/UCeVMnSShP_Iviwkknt83cww)
- MinutePhysics (https://www.youtube.com/user/minutephysics)
- Veritasium (https://www.youtube.com/Veritasium)
- William Fiset (https://m.youtube.com/@WilliamFiset-videos)
- Tushar Roy - Coding Made Simple (https://www.youtube.com/channel/UCZLJf_R2sWyUtXSKiKlyvAw) 
- 3Blue1Brown (https://www.youtube.com/c/3blue1brown/videos)
- Kartik Arora (https://www.youtube.com/@AlgosWithKartik/videos)
- Sanket Singh (https://www.youtube.com/channel/UCuDfiQK9CGFc4Tiz6MrdZ_A)
- Computerphile (https://www.youtube.com/computerphile)
- Neal Wu (https://m.youtube.com/@NealWuProgramming)
- CodeBeyond (https://m.youtube.com/c/CodeBeyond)
- Vivek Gupta (https://m.youtube.com/@vivekgupta3484)
- Clever Programmer (https://www.youtube.com/channel/UCqrILQNl5Ed9Dz6CGMyvMTQ)
- Career With Gaurav (https://m.youtube.com/@careerwithgaurav)
- CS Dojo (https://m.youtube.com/@Dojo_tech)
- C++Now (BoostCon) (https://www.youtube.com/user/Boostcon) (conference)
- code::dive conference (https://www.youtube.com/c/codediveconference/videos) (conference)
- Coding Blocks (https://www.youtube.com/channel/UCICWIYEx2mo4wYZzLwJ7wVw)
- Computer History (https://www.youtube.com/user/computerhistory)
- CppCon (https://www.youtube.com/user/cppcon) (conference)
- Facebook Developers (https://www.youtube.com/watch?v=Ctyu30oeVqE)
- Google Developers (https://developers.google.com/youtube)
- Gynvael Coldwin (https://www.youtube.com/c/GynvaelEN)
- HowToBecomeTV (https://m.youtube.com/watch?v=qhSmi75QZqY)
- Java (https://www.youtube.com/@java) (talks)
- JavaOne (https://www.youtube.com/watch?v=qRuFhmKQUlw) (conference)
- javidx9 (https://m.youtube.com/c/javidx9) (game and graphics tutorials)
- Meeting C++ YT Kanalseite (https://www.youtube.com/meetingcpp)
- [MIT OpenCourseWare](https://www.youtube.com/user/MIT/) 
- [Murtaza's OpenCV Robotics and AI](https://www.youtube.com/c/MurtazasWorkshopRoboticsandAI/)
- [Netflix UI Engineering](https://www.youtube.com/channel/UCGGRRqAjPm6sL3-WGBDnKJA/videos)
- [O'Reilly](https://www.youtube.com/user/OreillyMedia/videos) 
- [Placement Grid](https://www.youtube.com/user/PlacementGrid/videos) 
- [Scott Meyers: Past Talks](http://www.aristeia.com/presentations.html)
- [Siraj Raval](https://www.youtube.com/channel/UCWN3xxRkmTPmbKwht9FuE5A) 
- [ThinMatrix](https://www.youtube.com/user/ThinMatrix/videos) 
- [thoughtbot](https://www.youtube.com/user/ThoughtbotVideo/videos)
...
- [Geeksforgeeks](https://www.youtube.com/channel/UC0RhatS1pyxInC00YKjjBqQ/videos)
- [Hacker earth](https://www.youtube.com/channel/UCYU6nvKyRYnE5kiG9JXkXpA) 
- [Hak5](https://www.youtube.com/user/Hak5Darren) 
- [Khan Academy](https://www.youtube.com/channel/UC4a-Gbdw7vOaccHmFo40b9g) 
- [LearnCode.academy](https://www.youtube.com/channel/UCVTlvUkGslCV_h-nSAId8Sw)
- [Rachit Jain](https://www.youtube.com/channel/UC9fDC_eBh9e_bogw87DbGKQ/featured)
...
- [V. Anton Spraul](https://www.youtube.com/channel/UCLEMTlEe5RE04EoULMHWEEQ)
- [xdadevelopers](https://www.youtube.com/channel/UCk1SpWNzOs4MYmr0uICEntg) 
- [KudVenkat](https://www.youtube.com/user/kudvenkat/)
- [The Net Ninja](https://www.youtube.com/channel/UCW5YeuERMmlnqo4oq8vwUpg)
- [Web Dev Simplified](https://www.youtube.com/channel/UCFbNIlppjAuEX4znoulh0Cw)
...
- [Exponent](https://www.tryexponent.com/?src=nav)
...
- (Good challenges)[https://thecodingtrain.com/]https://know-it-all.io/
...
- (best resource on reddit)[https://www.reddit.com/r/learnprogramming/wiki/faq/#wiki_where_can_i_find_
ctice_exercises_and_project_ideas.3F]
...
## Github Repositories "i am interested in"

* [the-book-of-secret-knowledge](https://github.com/trimstray/the-book-of-secret-knowledge)
* [clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript)
* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line)
* [javascript-questions](https://github.com/ashCode98/javascript-questions)
* [Engineering-blogs](https://github.com/kilimchoi/engineering-blogs)
* [First-contributions](https://github.com/firstcontributions/first-contributions)
* [Freecodecamp](https://github.com/firstcontributions/first-contributions)
* [FAANG Preparation](https://github.com/AkashSingh3031/The-Complete-FAANG-Preparation)
* [leetcode-resources](https://github.com/ashishps1/awesome-leetcode-resources)
* [css-style-guide](https://github.com/dropbox/css-style-guide)
...
* [Front-end-Developer-Interview-Questions](https://github.com/h5bp/Front-end-Developer-Interview-Questions)
* [CodeChefVIT/resources](https://github.com/CodeChefVIT/resources)
* [learning-code-through-github-repos](https://github.com/muchirijane/learning-code-through-github-repos)
...
* [Awesome-beginner-open-source-contributions](https://github.com/mungell/awesome-for-beginners)
...
* [Awesome-reactJS](https://github.com/enaqx/awesome-react)
...
* [awesome-websites](https://github.com/lyfeyaj/awesome-resources)
...
* [Reddit-wiki-programming](https://github.com/avgspacelover/Reddit-wiki-programming)
* [PlacesToPostYourStartup](https://github.com/mmccaff/PlacesToPostYourStartup)
* [codelibrary](https://github.com/indy256/codelibrary)
* [SDFC](https://github.com/systemdesignfightclub/SDFC)
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness)
* [awesome-courses](https://github.com/prakhar1989/awesome-courses)
* [1on1-questions](https://github.com/ashCode98/1on1-questions)
* [how-web-works](https://github.com/vasanthk/how-web-works)
* [awesome-repositories](https://github.com/0xRitesh/awesome-repositories)
